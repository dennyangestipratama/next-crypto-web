  ...
  return (
    <tr className='text-base'>
        ...
        >
          <div className='flex items-center'>
            ...
            <div className='flex items-center flex-wrap flex-1'>
              ...
              <span className='text-custom-grey-02 mx-6 w-14'>
      ...
      <td className='w-56 border-b'>
        <p
          className={`${textColor} p-5 font-semibold transition-colors duration-1000 ease-in`}
        >
          {currencyFormatter(Number(getLatestPrice.latestPrice))}
        </p>
      </td>
      {/* Data: Day 24 Hrs */}
      <td className='p-2 font-semibold border-b w-32'>
        {renderPercentage(getLatestPrice?.day)}
      </td>
      {/* Data: Week 1 Week */}
      <td className='p-2 font-semibold border-b w-32'>
        {renderPercentage(getLatestPrice?.week)}
      </td>
      {/* Data: Month 1 Month */}
      <td className='p-2 font-semibold border-b w-32'>
        {renderPercentage(getLatestPrice?.month)}
      </td>
      {/* Data: Year 1 Year */}
      <td
        className={`p-2 font-semibold border-b border-r w-32 ${
          lastIndex ? 'rounded-br-lg' : ''
        }`}
      >
